/**
 * Builder portal — material display enrichment and SF notifications.
 */
...
export async function notifySfMaterialAction(pool, {
  ...
  if (action === 'approve_all') {
    subject = `Builder approved all materials — ${projLabel}`;
