-- ============================================
-- Senior Floors - Estimate Engine Schema
-- Sistema completo de estimativas para projetos de pisos
-- ============================================
...
CREATE TABLE IF NOT EXISTS `estimates` (
  ...
  `payment_schedule` json DEFAULT NULL COMMENT 'Cronograma de pagamento: [{type, percentage, amount, due_date}]',
...
-- ============================================
-- 3. ESTIMATE ITEMS (Itens da estimativa)
-- ============================================
...
-- ============================================
-- 5. ESTIMATE RULES (Regras inteligentes)
-- ============================================
