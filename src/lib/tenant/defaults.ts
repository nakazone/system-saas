...
export const DEFAULT_PERMISSIONS = [
  ...
  { key: "finance.view", group: "financial", description: "View finance module (cash flow, receivables, costs)" },
  { key: "finance.manage", group: "financial", description: "Manage finance costs, scans, and payroll abatements" },
