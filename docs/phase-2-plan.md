...
**Status:** M0 complete (recon + plan only). No product migrations or feature code in this milestone.  
**Branch:** `feat/phase2-m0-plan`  
...
- [x] Repository recon (schema, tenant layer, modules, CRM dual UI, views, tests, CI, public token pattern).  
- [x] This plan.  
- [ ] **Await review approval before M1** (no migrations in M0).

**Suggested M1 branch after approval:** `feat/phase2-m1-foundations`.
